...
type AddBadgeModalProps = {
  open: boolean;
  onClose: () => void;
  onAddOrUpdate: (badge: BadgeData) => void;
  initialValues?: Partial<BadgeData>;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl p-6 shadow-2xl">
        <h2 className="text-lg font-bold text-gray-900 mb-4">{initialValues ? "Modifier" : "Ajouter"} un badge</h2>
